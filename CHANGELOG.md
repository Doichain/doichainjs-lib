...
- `electrum.verifyChain`, `electrum.CHECKPOINTS` and `electrum.blockHash` to check that a server follows the Doichain chain of the fork, at block 431,018 – the first block the two chains do not share
